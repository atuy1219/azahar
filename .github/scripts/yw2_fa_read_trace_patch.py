...
def patch_fs_file() -> None:
    ...
    if "debug.azahar.yw2_fs_read_trace" not in text:
        ...
        helper = (
            ...
            "}\n\n"
            "void TraceYW2NestedPtrDump(u32 r3, u32 r4, u32 r6, u32 s00, u32 s08, u32 s0C) {\n"
            ...
            "    TraceYW2PtrDump(\"r3.w00\", YW2ReadWord(r3 + 0x00));\n"
            "    TraceYW2PtrDump(\"r3.w04\", YW2ReadWord(r3 + 0x04));\n"
            "    TraceYW2PtrDump(\"r3.w08\", YW2ReadWord(r3 + 0x08));\n"
            "    TraceYW2PtrDump(\"r3.w0C\", YW2ReadWord(r3 + 0x0C));\n"
            "    TraceYW2PtrDump(\"r4.w00_vtbl\", YW2ReadWord(r4 + 0x00));\n"
            "    TraceYW2PtrDump(\"r4.w14_buf\", YW2ReadWord(r4 + 0x14));\n"
            "    TraceYW2PtrDump(\"r6.w18\", YW2ReadWord(r6 + 0x18));\n"
            "    TraceYW2PtrDump(\"s00.w00_vtbl\", YW2ReadWord(s00 + 0x00));\n"
            "    TraceYW2PtrDump(\"s00.w14_buf\", YW2ReadWord(s00 + 0x14));\n"
            "    TraceYW2PtrDump(\"s08.w18\", YW2ReadWord(s08 + 0x18));\n"
            "    TraceYW2PtrDump(\"s0C.w00\", YW2ReadWord(s0C + 0x00));\n"
            "}\n\n"
            ...
            "        if (!dumped_ptrs) {\n"
            "            TraceYW2NestedPtrDump(r3, r4, r6, s00, s08, s0C);\n"
            "            dumped_ptrs = true;\n"
            "        }\n"
            "    }\n"
            "}\n\n"
...
print("Patched YW2 FS read nested pointer trace")
